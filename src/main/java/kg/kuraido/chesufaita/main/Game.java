...
import kg.kuraido.chesufaita.main.pieces.King;
import kg.kuraido.chesufaita.main.player.Player;
import kg.kuraido.chesufaita.main.Move.*;
...
public class Game {
    ...
    //check if it is legit / whether boolean or not
